...
// Componentes importados dos arquivos corretos
import { PurchaseCard } from '@/components/event/PurchaseCard';
import { EventHero } from '@/components/event/EventHero';
import { EventSections, EventDetailsSidebar } from '@/components/event/EventSections'; // ✅ Importação corrigida
...
export function EventDetail() {
    ...
    useEffect(() => {
        // Removi a chamada duplicada e deixei apenas a que está no useCallback
